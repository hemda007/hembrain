      ...
      <div className="container">
        ...
        <div className="brain-grid">
          <div className="brain-visual">
            <svg viewBox="0 0 360 250" className="brain-svg">
              <ellipse cx="180" cy="125" rx="150" ry="110" fill="none" stroke="var(--border-light)" strokeWidth="1" />
              <line x1="180" y1="20" x2="180" y2="230" stroke="var(--border-subtle)" strokeWidth="1" strokeDasharray="4,4" />
